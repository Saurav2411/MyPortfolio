...
export const Projects = () => {
  ...
  <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            {/* WeatherNow */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2">WeatherNow</h3>
              <p className="text-gray-400 mb-4">
                A real-time weather forecasting app providing accurate weather updates for any location worldwide.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["React", "OpenWeather API", "Tailwind CSS"].map((tech, key) => (
                  <span key={key} className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm transition-all hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)]">
                    {tech}
                  </span>
                ))}
              ...
              <div className="flex justify-between items-center">
                <a href="https://weather-now-flax.vercel.app/" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View Project →</a>
                <a href="https://github.com/Saurav2411/WeatherNow" className="text-gray-400 hover:text-gray-300 transition-colors my-4">GitHub</a>
              </div>
            </div>
          </div>
        </div>
